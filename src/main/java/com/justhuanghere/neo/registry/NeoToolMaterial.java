...
public enum NeoToolMaterial implements ToolMaterial {
    ...
    private NeoToolMaterial(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
